  ...
  function changeSliderLabel(size) {
    ...
    switch(size) {
      case "1":
        ...
        document.querySelector("#randomPizzas").setAttribute("class", "small");
        return;
      case "2":
        document.querySelector("#pizzaSize").innerHTML = "Medium";
        document.querySelector("#randomPizzas").setAttribute("class", "medium");
        return;
      case "3":
        document.querySelector("#pizzaSize").innerHTML = "Large";
        document.querySelector("#randomPizzas").setAttribute("class", "large");
        return;
      default:
